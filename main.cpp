...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	// 外部で宣言（クラスのメンバー変数など）
	Microsoft::WRL::ComPtr<ID3D12PipelineState> pPsoArray[kCountOfBlendMode];
	...
	viewport.Width = WindowWrapper::kClientWidth;
	viewport.Height = WindowWrapper::kClientHeight;
	viewport.TopLeftX = 0;
	viewport.TopLeftY = 0;
	...
	scissorRect.left = 0;
	scissorRect.right = WindowWrapper::kClientWidth;
	scissorRect.top = 0;
	scissorRect.bottom = WindowWrapper::kClientHeight;
	...
	Microsoft::WRL::ComPtr<ID3D12Resource> depthStencilResource = CreateDepthStencilTextureResource(device, WindowWrapper::kClientWidth, WindowWrapper::kClientHeight);
